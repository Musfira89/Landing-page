        ...
        <div className="lg:w-1/2 pl-36 flex justify-center mb-26 ">
          <ul className=" text-gray-500 text-lg">
            <li className="flex items-center mb-6">
              ...
              Personalized Insights with Actionable Recommendations</li>
            <li className="flex items-center mb-6">
              <BsSquare className="text-blue-500 border-blue-400 border-solid border-4 mr-3 p-1" />
              Empowering Self-Assessment at Home </li>
            <li className="flex items-center mb-6">
              <BsSquare className="text-blue-500 border-blue-400 border-solid border-4 mr-3 p-1" />
            ...
            <li className="flex items-center mb-6">
              <BsSquare className="text-blue-500 border-blue-400 border-solid border-4 mr-3 p-1" />
              Real-Time Progress Tracking </li>
            <li className="flex items-center mb-6">
              <BsSquare className="text-blue-500 border-blue-400 border-solid border-4 mr-3 p-1" />
              Guidance at Your Fingertips with a Virtual Chatbot</li>
            <li className="flex items-center mb-6">
              <BsSquare className="text-blue-500 border-blue-400 border-solid border-4 mr-3 p-1" />
              Visual Representation for a Clear Understanding </li>
          </ul>
        </div>
